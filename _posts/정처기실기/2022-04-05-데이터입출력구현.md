...
### 관계 대수
 : RDB에 관계로 표현된 데이터 취급 → 대수적인 연산체계, <b><span style='color:#006DD7'>절차적 정형 언어 (순서 명시)</span></b>
...
### 관계 해석
 : 튜플/도메인 관계 해석 → Predicate Calculus 기반, <b><span style='color:#006DD7'>비절차적 언어 (원하는 정보가 무엇인지만 선언)</span></b>

- 튜플 관계 해석 (논리기호 사용)
- 도메인 관계 해석
- 논리기호 (연산자 : AND, OR, NOT / 정량자 : 전칭전량자 ∀, 존재정량자 ∃)

## <b>📝</b> 데이터 모델 구성요소 <b><span style='color:#2D3748; background-color:#fff5b1'>(구연제)</span></b>
...
## <b>📝</b> 데이터 모델링 절차 <b><span style='color:#2D3748; background-color:#fff5b1'>(개논물)</span></b>
